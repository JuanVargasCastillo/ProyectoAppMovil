package com.miapp.greenbunny.api // Paquete de configuración de API

import com.miapp.greenbunny.BuildConfig // Import de constantes generadas por Gradle (BuildConfig)

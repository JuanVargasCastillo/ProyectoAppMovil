package com.miapp.greenbunny.ui // Paquete de la Activity principal de la app
...
import com.miapp.greenbunny.api.TokenManager // Import de nuestra clase para gestionar token/usuario
import com.miapp.greenbunny.databinding.ActivityHomeBinding // Import del ViewBinding del layout activity_home.xml
import com.miapp.greenbunny.ui.fragments.AddProductFragment // Import del fragmento para agregar productos
import com.miapp.greenbunny.ui.fragments.ProductsFragment // Import del fragmento que lista productos
import com.miapp.greenbunny.ui.fragments.ProfileFragment // Import del fragmento de perfil
    ...
    override fun onCreate(savedInstanceState: Bundle?) { // Métodoo de ciclo de vida: se llama al crear la Activity
        ...
        binding.bottomNav.setOnItemSelectedListener { item -> // Listener para navegación inferior
            when (item.itemId) { // Decidimos qué fragment mostrar según el ítem
                com.miapp.greenbunny.R.id.nav_profile -> replaceFragment(ProfileFragment()) // Ir al perfil
                com.miapp.greenbunny.R.id.nav_products -> replaceFragment(ProductsFragment()) // Ir a productos
                com.miapp.greenbunny.R.id.nav_add -> replaceFragment(AddProductFragment()) // Ir a agregar producto
            }

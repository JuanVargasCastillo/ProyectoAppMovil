...
import com.miapp.greenbunny.api.RetrofitClient // Nuestra clase personalizada para crear instancias del cliente de red (Retrofit).
import com.miapp.greenbunny.databinding.FragmentAddProductBinding // Clase generada automáticamente por ViewBinding para acceder a las vistas del XML de forma segura.
import com.miapp.greenbunny.model.CreateProductRequest // Nuestro modelo de datos (data class) que define la estructura del JSON para crear un producto.
import com.miapp.greenbunny.model.ProductImage // Nuestro modelo que representa un objeto de imagen completo devuelto por la API.
import com.miapp.greenbunny.ui.adapter.ImagePreviewAdapter // El adaptador para nuestro RecyclerView, que mostrará las imágenes seleccionadas.
